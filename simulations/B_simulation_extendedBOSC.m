function A_simulation_extendedBOSC(variant)
...
if ismac
    pn.root = '/Volumes/EEG/BOSC_Simulation/17_BOSCtoolbox/';
    %pn.root = '/Volumes/tardis/';
    addpath([pn.root, 'helper/']);
else
    pn.root = '/home/mpib/kosciessa/';
end
pn.out      = pn.root;%[pn.root, 'SternBRest_data/D_simulation/'];
...
load([pn.out 'background.mat'],'bckgrnd_filt')
