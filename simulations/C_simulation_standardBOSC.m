...
pn.root     = '/home/mpib/kosciessa/'; addpath([pn.root, 'helper']);
...
%%  load background
    ...
    load([pn.dataIN 'background.mat'],'bckgrnd_filt')
...
%%  BOSC - standard fit
    ...
    % background power estimation [JQK change: calculate this across all simulated trials]
