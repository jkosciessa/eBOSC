...
Kosciessa, J. Q., Grandy, T. H., Garrett, D. D., Werkle-Bergner, M. (in prep.). Single-trial characterization of neural rhythms: potentials and challenges
...
The scripts producing the simulation files as well as the relevant supplementary plots in the paper can be found in the subdirectory 'simulations'. Note that only the scripts are provided and the paths need to be adjusted.
